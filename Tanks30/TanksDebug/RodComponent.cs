...
namespace TanksDebug
{
    ...
    /// Componente barra
    /// </summary>
    public class RodComponent : DrawableGameComponent
    {
        /// <summary>
        /// Barra
        /// </summary>
        ...
        public RodComponent(Game game, Vector3 worldPoint, IPhysicObject obj, Vector3 relativeContactPoint, float size)
