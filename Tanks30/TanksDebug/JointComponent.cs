...
namespace TanksDebug
{
    ...
    /// Componente unión
    /// </summary>
    public class JointComponent : DrawableGameComponent
    {
        /// <summary>
        /// Unión
        /// </summary>
        ...
        public JointComponent(
            ...
            : base(game)
        {
            this.Joint = new Joint(objOne, relativeContactPointOne, objTwo, relativeContactPointTwo, size);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector3 trnPositionOne = this.Joint.PointOneWorld;
            Vector3 trnPositionTwo = this.Joint.PointTwoWorld;
