...
namespace GameComponents.Components.Particles
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        // Custom effect for drawing point sprite particles. This computes the particle animation entirely in the vertex shader: no per-particle CPU work required!
        ...
        // A vertex buffer holding our particles. This contains the same data as the particles array, but copied across to where the GPU can access it.
